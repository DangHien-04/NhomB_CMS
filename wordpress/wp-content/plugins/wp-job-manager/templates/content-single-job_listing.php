...
a.btn-share {
    ...
    transition: all 0.3s;
    box-sizing: border-box; /* Quan trọng: Tính border và padding vào width/height */
}
...
input.application_button {
    ...
    justify-content: center;
    width: 100%;
    height: 48px !important; /* Cố định chiều cao bằng nút SHARE */
    line-height: 1 !important; /* Giúp căn chỉnh văn bản bên trong */
    
    /* Thiết kế màu cam */
    background: #d4a576 !important; /* Đã đổi màu nền thành cam */
    border: 1px solid #d4a576 !important;
    color: #ffffff !important; /* Đã đổi màu chữ thành trắng */
...
input.application_button:hover {
    background-color: #b58b5f !important; /* Màu cam đậm hơn khi hover */
...
@media (max-width: 768px) {
    ...
    .cn-form input[type="email"] { padding: 0 15px 0 50px; }
